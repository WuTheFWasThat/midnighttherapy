...
`javascript: $.get('https://raw.githubusercontent.com/WuTheFWasThat/midnighttherapy/master/pathery-full.js', eval)`

### CONSOLE ###

If all else fails, you can access the script by pasting

`$.get('https://raw.githubusercontent.com/WuTheFWasThat/midnighttherapy/master/pathery-full.js', eval)`
...
`$.get('https://raw.githubusercontent.com/WuTheFWasThat/midnighttherapy/master/pathery-client.js', eval)`
